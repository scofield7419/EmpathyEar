...
class ModelArguments:
    ...
    lora_checkpoint: str = field(
        # default='/mnt/haofei/MSA/ChatGLM3/finetune_basemodel_demo/output/ERC-20231215-144805-1e-4/pytorch_model.pt',
        default=None,
...
class DataTrainingArguments:
    ...
    train_file: Optional[str] = field(
        default="/mnt/haofei/MSA/flan-T5/data/ChatGLM-ECAC/CEE-prompt/train.json",
        metadata={"help": "The input training data file (a jsonlines or csv file)."}
    )

    val_file: Optional[str] = field(
        default="/mnt/haofei/MSA/flan-T5/data/ChatGLM-ECAC/CEE-prompt/val.json",
