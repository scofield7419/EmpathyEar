...
class EAT():
    ...
    def prepare_test_data(self, img_path, audio_path, opt, emotype, use_otherimg=True):
        ...
        # gt frame number
        frames = glob.glob(f'{self.root_wav}/images_evp_25/cropped/*.jpg')
    ...
    def extract_keypoints(self, extract_list):
        kp_detector, he_estimator = self.load_checkpoints_extractor(config_path='config/vox-256-spade.yaml', checkpoint_path='./ckpt/pretrain_new_274.pth.tar')
    ...
    def test(self, ckpt, emotype, save_dir=" "):
        # cur_path = os.getcwd()
...
if __name__ == '__main__':
    ...
    # argparser.add_argument("--root_wav", type=str, default='/mnt/haofei/MSA/MERG/demo_wavout')
    argparser.add_argument("--root_wav", type=str, default='./demo/video_processed/M003_neu_1_001')
    ...
    eat.test(f'./ckpt/{name}.pth.tar', args.emo, save_dir=f'/mnt/haofei/MSA/MERG/TalkingFace_out/{name}/')
