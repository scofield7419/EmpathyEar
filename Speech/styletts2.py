...
class StyleTTS2:
    def __init__(self):
        ...
        self.global_phonemizer = phonemizer.backend.EspeakBackend(language='en-us', preserve_punctuation=True,
                                                             with_stress=True)
        self.config = yaml.safe_load(open("/mnt/haofei/MSA/MERG/StyleTTS2/StyleTTS2-LibriTTS/Models/LibriTTS/Models_LibriTTS_config.yml"))
    ...
    def initialize_model(self):
        ...
        params_whole = torch.load("/mnt/haofei/MSA/MERG/StyleTTS2/StyleTTS2-LibriTTS/Models/LibriTTS/epochs_2nd_00020.pth", map_location='cpu')
