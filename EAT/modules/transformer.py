...
import torch
from EAT.modules.util import mydownres2Dblock
import numpy as np
from EAT.modules.util import AntiAliasInterpolation2d, make_coordinate_grid
...
from EAT.Utils.JDC.model import JDCNet
from EAT.modules.audioencoder import AudioEncoder, MappingNetwork, StyleEncoder, AdaIN, EAModule
...
def get_rotation_matrix(yaw, pitch, roll):
    ...
    return yaw, pitch, roll, yaw_mat.reshape(yaw_mat.shape[0], 9), pitch_mat.reshape(pitch_mat.shape[0], 9), roll_mat.reshape(roll_mat.shape[0], 9), rot_mat.reshape(rot_mat.shape[0], 9)
