...
import numpy as np
from EAT.modules.audioencoder import MappingNetwork, AudioEncoder, MappingDeepNetwork
...
from EAT.modules.transformer import TransformerST, PositionalEncoding
